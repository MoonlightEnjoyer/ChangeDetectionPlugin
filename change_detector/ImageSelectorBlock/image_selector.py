...
class ImageSelector():
    def request_images_data(self, product_info_early, product_info_late, api):
        products_early = api.images_data_request(product_info_early.coordinates.latitude, product_info_early.coordinates.longitude, product_info_early.year, product_info_early.max_cloud_cover)
        products_late = api.images_data_request(product_info_late.coordinates.latitude, product_info_late.coordinates.longitude, product_info_late.year, product_info_late.max_cloud_cover)
